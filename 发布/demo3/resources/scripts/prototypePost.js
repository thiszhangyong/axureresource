// 8.0.0.3310. Generated 9/22/2016 9:29:42 PM UTC
...
$axure.internal(function($ax) {
    ...
    var _refreshRepeater = function(repeaterId, eventInfo, itemsPregen) {
        ...
        if(itemsPregen) {
            ...
            if($jobj('u0').css('box-sizing') == 'border-box') {
                startTop -= $ax.getNumFromPx($jobj(repeaterId).css('border-top-width')) || 0;
                startLeft -= $ax.getNumFromPx($jobj(repeaterId).css('border-left-width')) || 0
            }
            var top = startTop;
            var left = startLeft;
